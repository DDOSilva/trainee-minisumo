...
void Vision::update(){
    ...
    else if(sensor_fl.state) enemy_position = EnemyPosition::FULL_LEFT, latest_position = EnemyPosition::FULL_LEFT, return;
    else if(sensor_fr.state) enemy_position = EnemyPosition::FULL_RIGHT, latest_position = EnemyPosition::FULL_RIGHT, return;
